...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    Optional<Booking> findByItemIdAndAndBookerId(long itemId, long renterId);
    ...
    @Query("""
        ...
        ORDER BY b.end DESC
    """)
    Optional<Booking> findItemLastBooking(@Param("itemId") long itemId);
    ...
    """)
    Optional<Booking> findItemNextBooking(@Param("itemId") long itemId);
}
