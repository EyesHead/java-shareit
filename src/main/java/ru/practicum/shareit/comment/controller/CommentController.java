...
public class CommentController {
    ...
    public CommentResponseDto createCommentByRenter(@PathVariable("itemId") long itemId,
        ...
        log.info("Received request to create a comment for itemId: {}, authorId: {}", itemId, authorId);
        ...
        log.info("Successfully created comment with ID: {} for itemId: {}", response.getId(), itemId);
        return response;
    }
}
